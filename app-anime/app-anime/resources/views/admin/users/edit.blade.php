...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <h3>Edit users</h3><br />
                <form class="forms-sample" action="{{ url('/admin/users', $users->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Name users" value="{{ $users->name }}">
                            @if (count($errors) > 0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="Email users" value="{{ $users->email }}">
                            @if (count($errors) > 0)
