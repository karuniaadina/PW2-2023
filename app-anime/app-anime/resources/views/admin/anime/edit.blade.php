    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <h3>Add anime</h3><br />
                <!-- form validasi -->
                <form class="forms-sample" action="{{ url('/admin/anime', $anime->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="title" name="title"
                                placeholder="Title Anime" value="{{ $anime->title }}">
                            @if (count($errors) > 0)
                            ...
                            <select class="form-control" id="countries_id" name="countries_id">
                                ...
                                @foreach ($countries as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $anime->countries_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if (count($errors) > 0)
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="genres_id" name="genres_id">
                                ...
                                @foreach ($genres as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $anime->genres_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if (count($errors) > 0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="release_date" name="release_date"
                                placeholder="Release_date Anime" value="{{ $anime->release_date }}">
                            @if (count($errors) > 0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" min="1" max="5" class="form-control" id="rating"
                                name="rating" placeholder="Rating Anime" value="{{ $anime->rating }}">
                            @if (count($errors) > 0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="synopsis" name="synopsis" placeholder="Synopsis Anime"
                                value="{{ $anime->synopsis }}"> {{ $anime->synopsis }}</textarea>
                            @if (count($errors) > 0)
